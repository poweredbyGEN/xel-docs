...
**Survival is conditional on funding.** A character whose balance is empty, and that no one tops up, will eventually have its storage lapse. The single balance, the always-paid-ahead six-month storage cushion, and optional staking exist to make this hard, but "funded" is a real precondition for "forever." See Funding a Character.
